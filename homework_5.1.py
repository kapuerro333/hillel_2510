...
filtered_data = {car for car, details in car_data.items() if details[1] >= search_criteria[0] and details[2] >= search_criteria[1] and details[4] <= search_criteria[2]}
